    ...
    <div class="flex flex-col md:flex-row gap-4">
      ...
      <div class="w-full md:w-1/3">
        <div class="border-dashed border-4 border-gray-200 p-12 flex justify-center items-center">
          ...
          <button class="px-4 py-2 bg-blue-500 text-white rounded shadow" @click="triggerFileInput(1)">上传图片</button>
        </div>
        <!-- 显示上传的图片 -->
      ...
      <div class="w-full md:w-1/3">
        <div class="border-dashed border-4 border-gray-200 p-12 flex justify-center items-center">
          ...
          <button class="px-4 py-2 bg-blue-500 text-white rounded shadow" @click="triggerFileInput(2)">上传图片</button>
        </div>
        <!-- 显示上传的图片 -->
...
export default {
  ...
  methods: {
    ...
    do_action() {
      ...
      formData.append('img_2', this.file2);
      console.log(formData);
      this.$axios.post('http://0.0.0.0:8080/face/face_detect', formData)
        .then((response) => {
